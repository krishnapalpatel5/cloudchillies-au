...
$(document).ready(function () {
  ...
  function populateCountries() {
    $.getJSON("countries.json", function (data) {
      ...
      var selectState = $("#myForm #country");
      selectState.empty();
      selectState.append(
        $("<option>", {
          value: "",
  ...
  $(document).ready(function () {
    ...
    $("#myContactForm").submit(function (event) {
      ...
      if (fn && email && mn && response) {
        ...
        formData.push({ name: "subject", value: "contact page" });
        $.ajax({
          type: "POST",
  ...
  $("#downloadPdf").on("submit", function (e) {
    ...
    if (email === "" || !emailPattern.test(email)) {
      ...
      if (personalEmailDomains.includes(domain)) {
        $("#downloadPdf")
          .find("#emailError")
          .html("Please use a company email address")
          .show();
        isValid = false;
      } else {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $("#form-message")
            ...
            .html(
              "Thank you! The Success Story has been sent to your email address. You should receive it shortly."
            )
            .show();
          ...
          setTimeout(() => {
            ...
            $("body")
              ...
              .css({ overflow: "auto", "padding-right": "0px" });
