...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-6 d-flex  flex-column justify-content-center left ">
                                <div class="hero-text home-content">
                                    ...
                                    <div class="d-flex powered-by">
                                        <div>
                                            <img src="img/salesforce_snowflake_ai.svg">
                                            <!-- <img src="img/ai-sf-logo-mobile.png" class="mobile-b" > -->
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="logoList">
                        <div class="marquee">
                            <div class="marquee-content">
                                ...
                                <img src="img/trust-us/caritas-aus.png"
                                    alt="Caritas Australia nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/raise.png" alt="Raise nonprofit partner logo CloudChillies"
                                    style="width:200px;">
                                <img src="img/trust-us/united-way.png"
                                    alt="United Way nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/big-kitchen.png"
                                    alt="Big Kitchen nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/mnd-aus.png"
                                    alt="MND Australia nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/huntington-aus.png"
                                    alt="Huntington Australia nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/neuroblastoma-aus.png"
                                    alt="Neuroblastoma Australia nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/housing-hub.jpg"
                                    alt="Housing Hub nonprofit partner logo CloudChillies">
                                <img src="img/trust-us/learning-links.jpg"
                                    alt="Learning Links nonprofit partner logo CloudChillies">
    ...
    <section class="section position-relative sction-innerShadow">
                    ...
                    <div class="service-offring">
                        ...
                        <div class="service-right">
                            <div class="row">
                                ...
                                <div class="col-md-6 bdr-btm-0 nonprofitCta p-0">
                                    <div class="innerSection d-flex cta">
                                        <div class="left">
                                            <span class="bold">Connect with a Salesforce Expert </span>
                                        </div>
                                        <button class="btn btnStarted" data-bs-toggle="modal"
                                            data-bs-target="#contactUsPopup" data-subject="Home Page"
                                            data-section="Nonprofit Expert"
                                            onclick="return gtag_report_conversion()">Lets Get Started
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="25"
                                                    viewBox="0 0 15 25" fill="none">
                                                    <path
        ...
        <div class="container snlk-s-offerings service-offring">
            <div class="row">
                <div class="col-md-12">
                    <div class="service-offring">
                        <div class="service-left">
                            <div>
                                <div class="sectionTitle mb-4">
                                    <span class="bold"> Snowflake Service Offerings</span>
                                    <span class="lightWeight"> for</span>
                                    <span class="bold text-gradient">Nonprofits </span>


                                </div>
                                <p class="text-start">Helping non-profits turn data into meaningful insights for better
                                    programs, donor engagement, and impact measurement.
                                </p>
                        ...
                        <div class="service-right">
                            ...
                            <div class="row ">
                                <div class="col-md-6 pb-4">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4 mb-4">
                                            <img src="img/snflk-icon1.svg" alt="CloudChillies Snowflake icon 1">

                                            <h2 class="bold mb-0">Snowflake Consulting & Advisory</h2>
                                ...
                                <div class="col-md-6 pb-4">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4 mb-4">
                                            <img src="img/snflk-icon2.svg" alt="CloudChillies Snowflake icon 2">
                                            <h2 class="bold text-start">Snowflake Implementation</h2>
                                        </div>
                                        <p>
                                            Build scalable, secure Snowflake environments tailored for financial data —
                                            from
                            ...
                            <div class="row ">
                                <div class="col-md-6 pb-4 pt-4">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4 mb-4">
                                            <img src="img/snflk-icon3.svg" alt="CloudChillies Snowflake icon 3">
                                            <h2 class="bold text-start">Data Engineering & Integration
                                            </h2>
                                        </div>
                                        <p>
                                            Connect Snowflake with CRMs, core banking systems, APIs, and third-party
                                            data
                                ...
                                <div class="col-md-6 pb-4 pt-4">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4 mb-4">
                                            <img src="img/snflk-icon4.svg" alt="CloudChillies Snowflake icon 4">
                                            <h2 class="bold text-start">Analytics & Reporting</h2>
                                        </div>
                                        <p>
                                            Enable real-time financial reporting, portfolio insights, and executive
                                            dashboards —
                            ...
                            <div class="row">
                                <div class="col-md-6 pb-4 pt-4 bdr-btm-0">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4 mb-4">
                                            <img src="img/snflk-icon5.svg" alt="CloudChillies Snowflake icon 5">
                                            <h2 class="bold text-start">Governance, Security & Compliance</h2>
                                        </div>
                                        <p>
                                            Implement role-based access, data masking, auditability, and compliance
                                            frameworks
                                ...
                                <div class="col-md-6 pb-4 pt-4 bdr-btm-0">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4 mb-4">
                                            <img src="img/snflk-icon6.svg" alt="CloudChillies Snowflake icon 6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="innerSection d-flex">
                        <div class="left">
                            <span class="bold">Scale</span> <span class="lightWeight">your</span> <span
                                class="bold">Business</span>
                            <span class="lightWeight">with</span> <span class="bold">Data Driven Outcomes</span>.
                        </div>
                        <button class="btn btn-primary btnStarted" data-bs-toggle="modal"
                            data-bs-target="#contactUsPopup" data-subject="Nonprofit Page"
                            data-section="Snowflake Service Offerings">Contact Now <span>
                ...
                <div class="col-xl-8 text-center">
                    ...
                    <div class="call-to-action si b d-flex align-items-center justify-content-between">
                        ...
                        <a href="/salesforce" class="btn btn-primary btnStarted " data-bs-toggle="modal"
                            data-bs-target="#contactUsPopup" data-subject="Non-profit Page"
                            data-section="Contact us">Contact Us
    ...
    <section class=" npo-banner p-5 position-relative ai-powered-sol">
        <div class="container ">
            <div class="ai-robot">
                        ...
                        <div class="col-md-12">
                            <div class="call-to-action ai d-flex align-items-center justify-content-between">
                                ...
                                <a href="/ai-contact" class="btn btn-primary btnStarted " data-bs-toggle="modal"
                                    data-bs-target="#contactUsPopup" subject="Non-profit Page"
                                    data-section="Learn more">Learn More
                                    <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34"
                                        fill="none">
                                        <path d="M11.5664 6.7124L22.0224 17.1684L11.5664 27.6245" stroke="white"
                                            stroke-width="3.70531" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <section class="client-section bt-0">
        <section class="sectionSix section pt-0">
                ...
                <div class="row clientSlider">
                    <div class="owl-carousel clientFeeback owl-theme p-0">
                        ...
                        <div class="item">
                            <div class="iframe-container">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/G2lQODLUJOM?si=u2ifUfHwJqbVgVCE"
                        ...
                        <div class="item">
                            <div class="iframe-container">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/v5Ju3rcgh0s?si=7j6y4C3uOR4ZZJ17"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        ...
                        <div class="item">
                            <div class="iframe-container">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/QGjOKUj8fu8?si=dEAc8h3KUJXss9Xc"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        ...
                        <div class="item">
                            <div class="iframe-container">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/bxDlPhTMGEQ?si=6ZnvAmrJFy3cRTGT"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="call-to-action ss d-flex align-items-center justify-content-between">
                        ...
                        <a href="" class="btn btnStarted  position-relative" data-bs-toggle="modal"
                            data-bs-target="#contactUsPopup" data-subject="Non-profit Page"
                            data-section="Show Me How">Show Me How
    ...
    <section class="section8">
        <div class="container">
            <div class="row">
                <div class="sectionTitle text-center aos-init aos-animate mt-5 mb-3 mb-md-5" data-aos="fade-up">
                    <span class="lightWeight">Why Choose Us as Your </span>
                    <span class="bold text-gradient">Technology Partner?</span>
                </div>
                            ...
                            <div class="wrap-layout-area wrap-layout-2" data-aos="fade-up">
                                <div class="gridInner">
                                    <div class="gridInner-content">
                                        ...
                                        <p>Deep experience across education, health, community, and youth orgs.</p>
            ...
            <div class="row">
                <div class="left col-md-7 pt-4">
                    <div class="leftInner">
                        ...
                        <div class="helpPara aos-init aos-animate pb-3" data-aos="fade-right">
                        ...
                        <div class="talkAbout d-flex align-items-center flex-wrap aos-init aos-animate mt-4"
                            ...
                            <a href="/contact" class="btn btn-primary btnStarted" data-bs-toggle="modal"
                                style="font-size: 22px !important;" data-bs-target="#contactUsPopup"
                                data-subject="Nonprofits Page" data-section="Lets talk about your mission">Talk to Our
                                Nonprofits Experts
                ...
                <div class="right aos-init aos-animate col-md-5" data-aos="zoom-in">
                    <img src="img/snowflake_contactUs.webp" class="talk-people" alt="talk people">
                </div>
            </div>
        </div>
    </section>
