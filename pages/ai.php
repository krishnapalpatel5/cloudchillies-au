...
gtag('config', 'AW-17533579353');
    ...
    <div class=" position-relative">
        ...
        <section class="heroSection " id="homePage">
            <div class="heroBanner pt-4 heroBanner-inner aiHeroBanner">
                <div class="container header-container">
                    <div class="row ">
                        <div class="col-lg-6 col-xl-6 d-flex  flex-column justify-content-center left ">
                            <div class="hero-text home-content">
                                <h1 class="home-title-inner f-56 aiHeroBannerTitle">
                                    Building Smarter<span class="text-gradient">AI Systems</span>
                                    & Real Results For More Than
                                    <span class="text-gradient">20 Years!</span>
                                </h1>
                                <h2 class="mb-3"> </h2>
                                <p class="mb-5">
                                    AI-first solutions that learn and adapt that help your team move faster — from loan
                                    decisions to donor engagement, increasing your revenue along the way.
                                </p>
                                <div class="d-flex banner-btn">
                                    <a href="/contact" class="btn btnStarted  position-relative" data-bs-toggle="modal"
                                        data-bs-target="#contactUsPopup" data-subject="AI Page"
                                        data-section="Banner Section">
                        ...
                        <div class="col-lg-6 col-xl-6 ipadShow">
                            <img src="<?php echo $base_url?>img/ai_page/heroBg.png" alt="hero image icon"
                                class="img-fluid" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="mainHeading text-center">
                        <span class="lightWeight">Industry Focused,</span> <span class="bold text-gradient">AI
                            Ready</span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="<?php echo $base_url?>img/ai_page/image1.png" alt="arrow icon" class="ml-2">
                        <div class="bottomBx">
                            <div class="title">Finance</div>
                            <div class="dis">Use AI to improve lending precision, enhance fraud detection, and automate
                                customer journeys with less manual load.</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="<?php echo $base_url?>img/ai_page/image2.png" alt="arrow icon" class="ml-2">
                        <div class="bottomBx">
                            <div class="title">Non-Profit</div>
                            <div class="dis">Predict donor churn, automate volunteer scheduling, and forecast campaign
                                success — so you focus on the mission, not the mechanics.</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card moreIndusry">
                        <img src="<?php echo $base_url?>img/ai_page/image3.png" alt="arrow icon" class="ml-2">
                        <div class="bottomBx">
                            <div class="title">And more industries….</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="robotBxInner">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mainHeading text-center">
                            <span class="bold text-gradient">With AI</span>
                            <span class="lightWeight">: Work Smarter. Scale Faster.</span>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <!-- <div class="container">
             <div class="col-md-12">
                <img src="<?php echo $base_url?>img/ai_page/squreBg.svg" alt="squreBg">
             </div>
        </div> -->
        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="grid-container mb-5">
                            ...
                            <div class="items">
                                ...
                                <div class="ben-result dark-blue bold">
                                    <span class="lightWeight">By </span> 30% <img
                                        src="<?php echo $base_url?>img/arrow-down.png" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12 showToHow section3">
                <div class="innerSection d-flex bannerHeight margin0">
                    ...
                    <button class="btn btn-primary btnStarted" data-bs-toggle="modal" data-bs-target="#contactUsPopup"
                        data-subject="AI Page" data-section="See What Our Clients Have Achieved!">Let’s Talk
                        <div class="peopleList">
                            <span>
                                <img src="<?php echo $base_url?>img/ai_page/boy.png">
                            </span>
                            <span>
                                <img src="<?php echo $base_url?>img/ai_page/girl.png">
                            </span>
                            <span>
                                <img src="<?php echo $base_url?>img/ai_page/boy.png">
                            </span>
                ...
                <div class="owl-carousel full-slider home-slider owl-theme p-0">
                    ...
                    <div class="item">
                        <div class="sliderItem">
                            <img src="<?php echo $base_url?>img/ss/regents-banner.jpg">
                            <div class="sliderContent bg-3">
                                <div class="sliderContentInner">
                                    <div class="line1"> Success <span class="bold">Stories</span></div>
                                    <div class="c-logo">
                                        <img src="<?php echo $base_url?>img/ss/regents-white-logo.png" alt="" srcset="">
                                    </div>
                                    <div class="line2"> Redefining Regents Capital’s Equipment Financing &
                                        Leasing business with Salesforce.</div>
                    ...
                    <div class="item">
                        <div class="sliderItem">
                            <img src="<?php echo $base_url?>img/ss/brickworks-banner.jpg">
                            <div class="sliderContent bg-1 ">
                                <div class="ss-shape">
                                    <img src="<?php echo $base_url?>img/ss-shape.svg" alt="">
                                </div>
                                <div class="sliderContentInner">
                                    <div class="line1"> Success <span class="bold">Stories</span></div>
                                    <div class="c-logo">
                                        <img src="<?php echo $base_url?>img/ss/brickworks-white-logo.png" alt=""
                                            srcset="">
                                    </div>

                                    <div class="line2">Digitizing new product development and plant onboarding for
                                        Australia's largest brick manufacturer Brickworks</div>
                                    <a class="btn btn-secondry read_more_btn" data-bs-toggle="modal"
                                        data-bs-target="#ss-model" data-id="brickworks"><span>Read
                                            more</span> <img src="<?php echo $base_url?>img/arrow-right-b.svg"
                                            alt="arrow" width="24px"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="sliderItem">
                            <img src="<?php echo $base_url?>img/ss/capify-banner.jpg">
                            <div class="sliderContent bg-1 ">
                                <div class="ss-shape">
                                    <img src="<?php echo $base_url?>img/ss-shape.svg" alt="">
                                </div>
                                <div class="sliderContentInner">
                                    <div class="line1"> Success <span class="bold">Stories</span></div>
                                    <div class="c-logo">
                                        <img src="<?php echo $base_url?>img/ss/capify-white-log0.png" alt="" srcset="">
                                    </div>
                                    <div class="line2">Enabling Capify to extend Business Loans in Australia
                                        & UK with Salesforce</div>
                                    <a class="btn btn-secondry read_more_btn" data-bs-toggle="modal"
                    ...
                    <div class="item">
                        <div class="sliderItem">
                            <img src="<?php echo $base_url?>img/ss/smart-group-banner.jpg">
                            <div class="sliderContent bg-3">
                                <div class="sliderContentInner">
                                    <div class="line1"> Success <span class="bold">Stories</span></div>
                                    <div class="c-logo">
                                        <img src="<?php echo $base_url?>img/ss/smartgroup-logo-white.png" alt=""
                                            srcset="" class="sg">
                                    </div>
                                    <div class="line2">Digitizing salary packaging, leasing, and payroll services for
                                        Smartgroup with Salesforce and Azure
                                    </div>
                                    <a class="btn btn-secondry read_more_btn" data-bs-toggle="modal"
                                        data-bs-target="#ss-model" data-id="moneyspot"><span>Read
                                            more</span> <img src="<?php echo $base_url?>img/arrow-right-b.svg"
                                            alt="arrow" width="24px"></a>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="call-to-action ss d-flex align-items-center justify-content-between">
                        ...
                        <div class="cta-pattern">
                            <img src="<?php echo $base_url?>img/FW-hero-crop 1.png" alt="">
                        </div>
                        ...
                        <a href="" class="btn btnStarted  position-relative" data-bs-toggle="modal"
                            data-bs-target="#contactUsPopup" data-subject="AI Page" data-section="Success Stories">Show
                            Me
                            How
            ...
            <div class="d-flex">
                <div class="left pt-4">
                    <div class="leftInner">
                        ...
                        <img src="<?php echo $base_url?>img/ai-sf-logo.png" alt="icon">

                        <div class="talkAbout d-flex align-items-center flex-wrap aos-init mt-4">
                            <a href="/contact" class="btn  btnStarted">Talk to Our Salesforce + AI Experts <svg
                                    xmlns="http://www.w3.org/2000/svg" width="15" height="25" viewBox="0 0 15 25"
                                    fill="none">
                                    <path
                                        d="M0.690674 0.690674C1.41418 -0.032833 2.58631 -0.0328331 3.30981 0.690674L13.7659 11.1467C14.489 11.8703 14.4893 13.0425 13.7659 13.7659L3.30981 24.2219C2.58642 24.9453 1.4142 24.9451 0.690674 24.2219C-0.0328294 23.4984 -0.0328215 22.3263 0.690674 21.6028L9.83716 12.4563L0.690674 3.30981C-0.032833 2.58631 -0.0328331 1.41418 0.690674 0.690674Z"
                                        fill="white"></path>
