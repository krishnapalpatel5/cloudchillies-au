...
<head>
        ...
        <section class="heroSection salesforceBanner" id="homePage">
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-xl-6 d-flex  flex-column justify-content-center left ">
                            <div class="hero-text home-content">
                                ...
                                <h1 class="home-title-inner f-56">
                                    <span class="text-gradient">20+ Years</span>
                                    of Salesforce Expertise. Outcome-Driven. <br /> AI-Enabled.
                                    Integration-Ready.
                                </h1>
                                ...
                                <p class="mb-5">
                                    At Cloud Chillies, we don’t just implement Salesforce — we customize it to fit your
                                    industry, your team, and your goals. Whether you're in finance or the not-for-profit
                                    space, we help you get real results from day one.
                                </p>
            ...
            <section class="client-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="mainHeading text-center  mb-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="secondHeading text-center">See What Cloud Chillies Can Do for You
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid serviceBx-b position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="service-offring so-inner position-relative">
                        <!-- Left side -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="so-box so-box-inner">
                                        ...
                                        <h4>End-to-end Salesforce rollouts done right.</h4>
                                        <p class="mb-0">
                                            We specialise in fast, secure, and scalable Salesforce implementations for
                                            your
                                            business needs. Whether it’s a fresh setup or a complete overhaul, our team
                                            ensures a smooth start and lasting success.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box so-box-inner">
                                        ...
                                        <h4>Bringing your systems together, the smart way.</h4>
                                        <p class="mb-0">
                                            We connect Salesforce to your existing tech -ERPs, marketing platforms,
                                            finance
                                            tools, and more — so data flows seamlessly and teams stay aligned.
                                        </p>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box so-box-inner">
                                        ...
                                        <h4>Custom Salesforce solutions that power your growth.</h4>
                                        <p class="mb-0">
                                            From building custom apps to mobile integrations and next-gen use cases like
                                            IoT
                                            — we develop with purpose and precision.
                                        </p>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box so-box-inner">
                                        ...
                                        <p class="mb-0">
                                            As your needs change, we help your Salesforce org adapt — with performance
                                            tuning, admin support, and feature enhancements, all delivered with
                                            transparency
                                            and speed.
                                        </p>
            ...
            <div class="col-md-12">
                <div class="innerSection d-flex">
                    ...
                    <button class="btn btn-primary btnStarted" data-bs-toggle="modal" data-bs-target="#contactUsPopup"
                        data-subject="Salesforce" data-section="Salesforce Service Offerings">Let's
                        Get Started <span>
    ...
    <section class="section4 position-relative">
        ...
        <div class="container sectionInner2 position-relative">
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="innerSection d-flex">
                        ...
                        <button class="btn btn-primary btnStarted" data-bs-toggle="modal"
                            data-bs-target="#contactUsPopup" data-subject="Salesforce"
                            data-section="Ai with Salesforce">Contact Us Today<span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="25" viewBox="0 0 15 25"
                                    fill="none">
                                    <path
                                        d="M0.690674 0.690674C1.41418 -0.032833 2.58631 -0.0328331 3.30981 0.690674L13.7659 11.1467C14.489 11.8703 14.4893 13.0425 13.7659 13.7659L3.30981 24.2219C2.58642 24.9453 1.4142 24.9451 0.690674 24.2219C-0.0328294 23.4984 -0.0328215 22.3263 0.690674 21.6028L9.83716 12.4563L0.690674 3.30981C-0.032833 2.58631 -0.0328331 1.41418 0.690674 0.690674Z"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mainHeading ">
                            <span class="bold text-gradient">Clouds & Tech</span> <span class="lightWeight">We Work
                                With</span>
                        </div>
                        <div class="left-sub-heading ">We work across the Salesforce ecosystem-helping you choose the
                            right
                            tools, then tailoring them to fit.
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <section class="features tech-feature">
                                ...
                                <div class="card-box">
                                    ...
                                    <div>
                                        ...
                                        <p>Run campaigns that are personal, automated, and measurable </p>
                        ...
                        <div class="tech-right-b tech-sf-hero">
                            <div class="innerSection d-flex cta-type-a">
                                <div class="lightWeight left small">Unlock the <span class="bold">Full Potential
                                    ...
                                    <span class="bold">Salesforce</span> for Your <span class="bold">Business</span>.
                                </div>
                                <button class="btn btn-primary btnStarted" data-bs-toggle="modal"
                                    data-bs-target="#contactUsPopup" data-subject="Salesforce"
                                    data-section="Clouds & Tech We Work With">Let's Get Started <span>
                            ...
                            <div class="wrap-layout-area wrap-layout-1" data-aos="fade-up">
                                <div class="gridInner">
                                    <div class="gridInner-content">
                                        ...
                                        <p>
                                            We don't juggle platforms. We live and breathe Salesforce — across clouds,
                        ...
                        <div class="wrap-layout-area wrap-layout-5" data-aos="fade-up">
                            <div class="gridInner flex-row">
                                <div class="gridInner-content">
                                    ...
                                    <p>
                                        Certified across core and industry clouds — from strategy to implementation and
                                        support.
                                    </p>
                                </div>
                                <!-- <div class="no"><img src="<?php echo $base_url?>img/one.svg"></div> -->
                        ...
                        <div class="wrap-layout-area wrap-layout-3" data-aos="fade-up">
                            <div class="gridInner">
                                <div class="gridInner-content">
                                    ...
                                    <p>
                                        We embed Salesforce-native AI and GPT workflows to help you automate what
                                        matters.
                                    </p>
                                </div>
                                <!-- <div class="no"><img src="<?php echo $base_url?>img/one.svg"></div> -->
                        ...
                        <div class="wrap-layout-area wrap-layout-6" data-aos="fade-up">
                            <div class="gridInner">
                                <div class="gridInner-content">
                                    ...
                                    <p>
                                        A track record of reliable delivery, secure setups, and long-term client
                                        relationships.
                                    </p>
                                </div>
                                <!-- <div class="no"><img src="<?php echo $base_url?>img/one.svg"></div> -->
                    ...
                    <div class="d-flex flex-column c">
                        <div class="wrap-layout-area wrap-layout-4" data-aos="fade-up">
                            <div class="gridInner flex-row">
                                <div class="gridInner-content">
                                    <div class="gridTitle">
                                        Certified Experts, Not Middlemen
                                    </div>
                                    <p>
                                        No fluff, no handoffs — just real Salesforce professionals who own your
                                        outcomes.
                                    </p>
                    ...
                    <div class="leftInner">
                        ...
                        <div class="talkAbout d-flex align-items-center flex-wrap aos-init mt-4">
                            <a href="/contact" class="btn  btnStarted" data-bs-toggle="modal"
                                data-bs-target="#contactUsPopup" data-subject="Salesforce"
                                data-section="Let's Talk">Contact Us Now
