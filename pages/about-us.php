...
gtag('config', 'AW-17533579353');
    ...
    <div class="mainBanner npo-section position-relative aboutBanner">
    ...
    <div class="container-fluid logoBx b">
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex">
                    <div class="trustTitle b">Awards & Recognitions</div>


                    <div class="logoList">
                        <div class="marquee">
                            <div class="marquee-content-b">
    ...
    <!-- Who We Are -->
    <!------------------------------>
    <section class="sectionTen who-we-are">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="aboutTitle">Who We Are</div>
                    <p>We're a global team of Salesforce and AI specialists with deep technical roots and practical
                        business insight. Our focus is simple: help organisations increase revenue, reduce manual
                        overhead, and deliver better services using scalable technology.</p>
                    <p>We've led hundreds of transformation projects across industries-with special strength in
                        financial services and nonprofits-giving us the hands-on knowledge to solve real-world
                        challenges, not just system requirements.</p>
                    <p>What sets us apart? A commitment to precision, reliability, and solutions that actually make
                        life
                        easier for your teams.</p>
                </div>
            </div>
        </div>
    </section>
    <section class="sectionEleven">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="aboutSubTitle">Leadership Team</div>
                    <div class="teamDetail d-flex align-items-center">
                        <div class="teamList d-flex justify-content-center align-items-center">
                            <div class="list">
                                <div class="profilePic">
                                    <img src="<?php echo $base_url?>img/shishir.png" alt="shishir Danani">
                                </div>
                                <div class="name">Shishir Danani</div>
                                <div class="post">CEO</div>
                            </div>
                            <div class="list">
                                <div class="profilePic">
                                    <img src="<?php echo $base_url?>img/sateesh.png" alt="Sateesh Chandrashekar">
                                </div>
                                <div class="name">Sateesh Chandrashekar</div>
                                <div class="post">CTO</div>
                            </div>
                            <div class="list">
                                <div class="profilePic">
                                    <img src="<?php echo $base_url?>img/avinash.png" alt="Avinash Kumar">
                                </div>
                                <div class="name">Avinash Kumar</div>
                            ...
                            <ul>
                                <li class="d-flex gap-2">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38"
                                        fill="none">
                                        <path
                                            d="M19.4323 34.5004C27.9115 34.5004 34.849 27.5629 34.849 19.0838C34.849 10.6046 27.9115 3.66711 19.4323 3.66711C10.9531 3.66711 4.01562 10.6046 4.01562 19.0838C4.01562 27.5629 10.9531 34.5004 19.4323 34.5004Z"
                                            stroke="#00458C" stroke-width="2.75" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M12.8828 19.0837L17.2457 23.4466L25.987 14.7208" stroke="#00458C"
                                ...
                                <li class="d-flex gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38"
                                        ...
                                        <path d="M12.8828 19.0837L17.2457 23.4466L25.987 14.7208" stroke="#00458C"
                                            stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg><span><span> Alumni of top engineering & business schools in USA &
                                            India</span></span>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="global-footprints">
                    <!-- Left Text -->
                    <div class="global-text">
                        <h2 class="mb-4">Global Footprints</h2>
                        <ul>
                            <li class="d-flex gap-3 align-items-center"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="d-flex gap-3 align-items-center flex-wrap"><span>USA</span><span>|</span>
                            ...
                            <li class="d-flex gap-3 align-items-center"> <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path d="M12.8828 19.0837L17.2457 23.4466L25.987 14.7208" stroke="#00458C"
                                        stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" />
                                </svg><span class="d-flex gap-3 align-items-center flex-wrap">Helping Australian
                                    businesses
                                    for over 20 years</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="servicesHeadingBx">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mainHeading bold">What we do</div>

                    <div class="secondHeading">We deliver transformational value through end-to-end Salesforce
                        services and AI, empowering businesses to streamline operations, enhance efficiency, and
                        accelerate
                        growth.
                    </div>
    ...
    <div class="container-fluid serviceBx b mb-5">
                    ...
                    <div class="service-offring">
                        ...
                        <div class="service-right abt-service-right">
                            <div class="mainHeading abt">
                                <span class="lightWeight">Our</span> <span class="bold text-gradient">Salesforce
                                    Service
                                    Offerings</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="so-box">
                                        ...
                                        <p class="mb-0">
                                            Seamless rollout of Salesforce across Sales, Service, Marketing, and
                                            Industry
                                            Clouds.
                                        </p>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box">
                                        ...
                                        <p class="mb-0">
                                            Connect Salesforce with ERP, core systems, and third-party apps for a
                                            unified
                                            ecosystem.
                                        </p>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box">
                                        ...
                                        <p class="mb-0">
                                            Build tailored solutions, mobile apps, and next-gen capabilities on
                                            Salesforce.
                                        </p>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box">
                                        ...
                                        <p class="mb-0">
                                            Ongoing optimization, monitoring, and on-demand support for your
                                            Salesforce
                                            Org.
                                        </p>
                                ...
                                <div class="col-md-6 bdr-btm-0">
                                    <div class="so-box d-flex flex-column gap-3">
                                        <div class="d-flex sf-points gap-4">
                                            <img src="<?php echo $base_url?>img/app-exchange-icon.svg" alt="">
                                            <h2 class="bold text-start">AppExchange Development</h2>
                                        </div>
                                        <p class="mb-0">
                                            Ideation to publishing: take your product to market on AppExchange.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 bdr-btm-0">
                                    <div class="so-box d-flex flex-column gap-3">
                                        <div class="d-flex sf-points gap-4">
                                            <img src="<?php echo $base_url?>img/ai-cloud-icon.svg" alt="">
                                            <h2 class="bold text-start">AI + Automation</h2>
                                        </div>
                                        <p class="mb-0">
                                            Leverage Einstein GPT, predictive models, and intelligent workflows to
                                            automate
                                            what matters.
                                        </p>
                                    </div>
                        ...
                        <div class="service-left b">
                            <img src="<?php echo $base_url?>img/abt-sf-girl.png" class="img-fluid"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mainHeading text-center">
                        <span class="lightWeight">The</span>
                        <span class="bold text-gradient"> Results Speak</span>
                        <span class="lightWeight"> for Themselves</span>
                    </div>
                    <div class="speakSubHeading">
                        We don't like to brag, but when clients report up to 83% efficiency gains, it's worth
                        mentioning.
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="grid-container abt-us mb-5">
                        <div class="items">

                            <p class="ben-ponits dark-blue bold">
                                <span class="light-blue "> Manual Workload </span>
                                decreased
                            </p>
                        ...
                        <div class="items">
                            <p class="ben-ponits dark-blue bold">
                                <span class="light-blue "> Operational Cost </span>
                                decreased
                            </p>
                            <div class="ben-result dark-blue bold">
    ...
    <section class="industryContainer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mainHeading "><span class="text-gradient">Industry Leaders</span> Rely on Us</div>
                </div>
                <div class="col-md-12">
                    <div class="industryLogo position-relative">
                        <div class="countryName australia">
                            Australia
                        </div>
                        <div class="trustLogo ">
                            <ul class="d-flex align-items-center flex-wrap justify-content-center">
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo1.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo2.png" alt="logo"
                                        class="capify-logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo3.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo4.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo5.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo6.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo7.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo8.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo9.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo10.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>


                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo11.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo12.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>

                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo13.png" alt="logo" class="blend"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo14.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo15.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo16.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo17.png" alt="logo">
                                </li>

                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo18.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo19.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo20.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/au_logo/au-logo21.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="industryLogo position-relative">
                        <div class="countryName northAmerica
">
                            North America
                        </div>
                        <div class="trustLogo ">
                            <ul class="d-flex align-items-center flex-wrap justify-content-center">
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo1.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo2.png" alt="logo"
                                        class="capify-logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo3.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo4.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo5.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo6.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo7.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo8.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo9.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo10.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>


                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo11.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo12.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>

                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo13.png" alt="logo" class="blend"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo14.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo15.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo16.png" alt="logo">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/na_logo/na-logo17.png" alt="logo">
                                </li>
                    ...
                    <div class="industryLogo position-relative">
                        <div class="countryName EMEA">
                            EMEA
                        </div>
                        <div class="trustLogo ">
                            <ul class="d-flex align-items-center flex-wrap justify-content-center">
                                <li>
                                    <img src="<?php echo $base_url?>img/emra_logo/emra_logo1.png" alt="logo"
                                        style="mix-blend-mode: darken">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/emra_logo/emra_logo2.png" alt="logo"
                                        class="capify-logo" style="mix-blend-mode: darken">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/emra_logo/emra_logo3.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/emra_logo/emra_logo4.png" alt="logo"
                                        style="mix-blend-mode: darken">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/emra_logo/emra_logo5.png" alt="logo"
                                        style="mix-blend-mode: darken;">
                                </li>
                                <li>
                                    <img src="<?php echo $base_url?>img/emra_logo/emra_logo6.png" alt="logo">
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!------------------------------>
    <section class="valueContainer noIpad">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mainHeading text-center"><span class="text-gradient">Our Values</span> That Guide Us
                    </div>
                    <div class="d-flex justify-content-center align-items-center position-relative circleImg">
                        <img src="<?php echo $base_url?>img/value.svg" alt="value image" />
                    </div>
                    <div class="values-section">
                        <div class="value-box">
                            <h3>Build for Impact</h3>
                            <p>We craft solutions that aren’t just functional—they’re made to drive efficiency,
                                scale
                                confidently, and grow revenue where it counts.</p>
                        </div>
                        <div class="value-box">
                            <h3>Clarity Over Complexity</h3>
                            <p>No jargon, no mystery—just straightforward & practical solutions that make sense and
                                deliver results.</p>
                        </div>
                        <div class="value-box">
                            <h3>Own the Outcome</h3>
                            <p>We’re in it with you. From kickoff to completion, we stay accountable for real-world
                                results—not just checkboxes.</p>
                        </div>
                        <div class="value-box">
                            <h3>Adapt to Fit</h3>
                            <p>No two organisations are the same. We tailor our solutions and approach to your
                                industry,
                                workflows, and working methods.</p>
                        </div>
                        <div class="value-box">
                            <h3>Partner With Purpose</h3>
                            <p>We invest in long-term relationships, not quick wins. Many of our clients stick with
                                us
                                for years—and that’s by design.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- this is for Ipad and mobile -->
    <section class="valueContainer nodesktop">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="values-section">
                        <div class="valueOuterBx d-flex">
                            <div class="icon">
                                <img src="<?php echo $base_url?>img/icon1.svg" alt="value image" />
                            </div>
                            <div class="value-box">
                                <h3>Build for Impact</h3>
                                <p>We craft solutions that aren't just functional—they're made to drive efficiency,
                        ...
                        <div class="valueOuterBx d-flex">
                            <div class="icon">
                                <img src="<?php echo $base_url?>img/icon2.svg" alt="value image" />
                            </div>
                            <div class="value-box">
                                <h3>Clarity Over Complexity</h3>
                                <p>No jargon, no mystery—just straightforward & practical solutions that make sense
                                    and
                                    deliver results.</p>
                            </div>
                        </div>
                        <div class="valueOuterBx d-flex">
                            <div class="icon">
                                <img src="<?php echo $base_url?>img/icon3.svg" alt="value image" />
                            </div>
                            <div class="value-box">
                                <h3>Own the Outcome</h3>
                                <p>We’re in it with you. From kickoff to completion, we stay accountable for
                                    real-world
                                    results—not just checkboxes.</p>
                            </div>
                        </div>
                        <div class="valueOuterBx d-flex">
                            <div class="icon">
                                <img src="<?php echo $base_url?>img/icon4.svg" alt="value image" />
                            </div>
                            <div class="value-box">
                                <h3>Adapt to Fit</h3>
                                <p>No two organisations are the same. We tailor our solutions and approach to your
                        ...
                        <div class="valueOuterBx d-flex">
                            <div class="icon">
                                <img src="<?php echo $base_url?>img/icon5.svg" alt="value image" />
                            </div>
                            <div class="value-box">
                                <h3>Partner With Purpose</h3>
                                <p>We invest in long-term relationships, not quick wins. Many of our clients stick
                                    with
                                    us
                                    for years—and that's by design.</p>
                            </div>
    ...
    <!------------------------------>
    <!-- <section class="sectionNineContainer aboutNine">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mainHeading text-center">
            ...
            <div class="row sectionNine">
                <div class="col-md-12">
                    <div class="d-flex">
                        <div class="img">
                            <img src="<?php echo $base_url?>img/ai_page/leftImg.png" alt="image">
                        </div>
                        <div class="grid-container mb-5">
                            ...
                            <div class="items">
                                <p class="ben-ponits dark-blue bold">
                                    <span class="light-blue "> Revenue Growth Rate </span>
                                    increased
                                </p>
                                <div class="ben-result dark-blue bold">
                                    <span class="lightWeight">Up to </span> 20% <img
                            ...
                            <div class="items">
                                ...
                                <div class="ben-result dark-blue bold">
                                    <span class="lightWeight">By </span> 20% <img
                                        src="<?php echo $base_url?>img/arrow-down.png" alt="">
                                </div>
                            </div>
                            <div class="items">
                            ...
                            <div class="items">
                                <p class="ben-ponits dark-blue bold">
                                    <span class="light-blue "> Operational Cost </span>
                                    <span class="lightWeight">will</span> decrease
                                </p>
                                <div class="ben-result dark-blue bold">
                                    <span class="lightWeight">By </span> 20% <img
                                        src="<?php echo $base_url?>img/arrow-down.png" alt="">
    ...
    <!-- Why Choose Start -->
    <!------------------------------>
    <section class="position-relative why-choose-abt section  ">
    ...
    <!-- Lets Talk Start -->
    <!------------------------------>
    <section class="section9 aboutContact">
                    ...
                    <div class="left pt-4">
                        <div class="leftInner">
                            ...
                            <div class="talkAbout d-flex align-items-center flex-wrap aos-init mt-4">
                                <a href="/contact" class="btn  btnStarted">Talk to Our Experts
