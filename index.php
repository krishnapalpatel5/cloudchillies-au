...
$router= str_replace('/CC-2025','', $request);


// $base_url ="https://mindruby.com/fintech/";
...
$currentnav ='aboutus';
    ...
    $currentnav ='contact';
else if($currentPageWithoutPhp == 'nonprofits'||preg_match($pattern, $router, $matches))
...
break;
case '/about-us':include('./pages/aboutUs.php');
break;
