...
<body>
                ...
                <div class="container header-container">
                    <div class="row">
                        <div class="col-md-6 d-flex  flex-column justify-content-center left ">
                            <div class="hero-text">
                                <h1 class="line1 ">
                                    <span class="bannerText1">20+ Years</span>
                                    <span class="bannerText2"> of Delivering Transformational Value to</span>
                                    <span class="bannerText3">Top Financial Companies</span>
                                </h1>
                                <h1 class="line2"><span class="primary-text">with</span></h1>
    ...
    <section class="ai-powered-sol p-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">

                    <div class="sectionTitle mb-5 text-start m-5">
                        <span class="bold primary-text">AI Powered Solutions</span> <span class="lightWeight">For</span>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="call-to-action ai d-flex align-items-center justify-content-between">
                                ...
                                <a href="/ai-contact" class="btn btn-primary " data-bs-toggle="modal"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="call-to-action fc d-flex align-items-center justify-content-between">
                        ...
                        <a href="/expert-contact" class="btn btn-primary " data-bs-toggle="modal"
                            data-bs-target="#contactModal" onclick="gtag('event', 'cta_click', {
     'event_category': 'CTA',
            ...
            <div class="row">
                <div class="left col-md-7 pt-4">
                    <div class="leftInner">
                        ...
                        <img src="img/aiIcon.png" alt="icon">
                        <div class="talkAbout d-flex align-items-center flex-wrap aos-init aos-animate mt-4"
                            data-aos="fade-right">
                            <a href="/contact" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#contactModal" onclick="gtag('event', 'cta_click', {
     'event_category': 'CTA',
     'event_label': 'CTA - Contact Us Now'
   });">Contact Us Now<img src="img/arrow-white.svg" alt="arrow icon" class="ml-2"></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form class="row mb-0" id="myForm" method="post">
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <span class="error" id="cnameError">Please enter your company name </span>
                    </div>
                    <div class="mb-3 col-md-12">
                    ...
                    <div class="mb-3 col-md-12">
                        <textarea class="form-control" name="question" id="question" placeholder="How can we help? "
                    ...
                    <div class="mb-3 col-md-12">
                        <div class="g-recaptcha" data-sitekey="6LdNSigrAAAAAG7cGMQ2tH_DV4tu6X2H0kwN_e9o"
