...
<div class="mainBanner position-relative">
    ...
    <div class="pattern-bg">
        <img src="img/banner-pattern.png">
    </div>

    <div class="pattern-shape">
        <img src="img/banner-shape.svg" class="img-fluid">
    </div>
                ...
                <div class="row ">
                        ...
                        <div class="hero-text home-content">
                            ...
                            <div class="d-flex powered-by align-items-center">
                                ...
                                <div class="ai-sf-logo-banner">
                                    <img src="img/ai-sf-logo.png" alt="logo">
                                    <!-- <img src="http://localhost/lending-logik/img/lending-logik-imgs/ai-sf-logo-mobile.png" class="mobile-b" > -->
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-6 heroright">
                        <div class="servicesContainer  desktop ai-img">
                            <img src="img/banner-img.png" alt="logo" class="img-fluid">
                        </div>
                    ...
                    <div class="logoList">
                        <div class="marquee">
                            <div class="marquee-content">
                                <img src="img/home_page/logo1.png" alt="Logo 1">
                                <img src="img/home_page/logo2.png" alt="Logo 2">
                                <img src="img/home_page/logo3.png" alt="Logo 3">
                                <img src="img/home_page/logo4.png" alt="Logo 4">
                                <img src="img/home_page/logo5.png" alt="Logo 5">
                                <!-- duplicate logos for seamless loop -->
                                <img src="img/home_page/logo6.png" alt="Logo 1">
                                <img src="img/home_page/logo7.png" alt="Logo 2">
                                <img src="img/home_page/logo8.png" alt="Logo 3">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="service-offring">
                        ...
                        <div class="service-right">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4">
                                            <img src="img/home_page/multicloud.svg" alt="">
                                            <div>
                                ...
                                <div class="col-md-6">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4">
                                            <img src="img/home_page/salesforceIntegrations.svg" alt="">
                                ...
                                <div class="col-md-6">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4">
                                            <img src="img/home_page/salesforceDevelopment.svg" alt="">
                                ...
                                <div class="col-md-6">
                                    <div class="so-box">
                                        <div class="d-flex sf-points gap-4">
                                            <img src="img/home_page/manageService.svg" alt="">
                        ...
                        <div class="service-left">
                            <img src="img/home_page/salesforcePartner.png" class="img-fluid" alt="salesforce partner" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="innerSection d-flex">
                    ...
                    <button class="btn btn-primary btnStarted">Let's Get Started <span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center heading bold">
                        <span class="text-gradient">AI with Salesforce:</span> <span class=""> Making Every
                            Workflow</span>
                ...
                <div class="col-md-12">
                    <div class="d-flex">
                        <div class="section4Left">
                            <img src="img/home_page/agent.svg" alt="agentforce logo" />
                            ...
                            <div class="d-flex">
                                ...
                                <div class="rightSide">
                                    <div class="robotoImg">
                                        <img src="img/home_page/roboto.png" alt="roboto" />
                                    </div>
                                </div>
                            </div>
                            <div class="mt-2 leftpara">For Your Execution-ready Frontline</div>
                            <button class="btn btn-primary btnStarted">Let’s build your Agentforce POC <span>
                        ...
                        <div class="section4Right">
                            <section class="features">
                                <div class="card-box">
                                    <div class="icon"><img src="img/home_page/icon1.svg" alt="icon1"></div>
                                    <div>
                                ...
                                <div class="card-box">
                                    <div class="icon"><img src="img/home_page/icon2.svg" alt="icon1"></div>
                                    <div>
                                ...
                                <div class="card-box">
                                    <div class="icon"><img src="img/home_page/icon3.svg" alt="icon1"></div>
                                    <div>
                                ...
                                <div class="card-box">
                                    <div class="icon"><img src="img/home_page/icon4.svg" alt="icon1"></div>
                                    <div>
                                ...
                                <div class="card-box">
                                    <div class="icon"><img src="img/home_page/icon5.svg" alt="icon1"></div>
                                    <div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">AI-enhanced decision gates in loan origination, grants, etc.</p>
                ...
                <div class="col-md-12">
                    <div class="innerSection d-flex">
                        <div class="lightWeight left">We give an
                            <div> <span class="bold">Unf<span class="oragneText">(AI)</span>r advantage to </span>your
                                Business and</div> Maximise the ROI.
                        </div>
                        <button class="btn btn-primary btnStarted">Contact Us Today<span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="25" viewBox="0 0 15 25"
                                    fill="none">
                                    <path
                                        d="M0.690674 0.690674C1.41418 -0.032833 2.58631 -0.0328331 3.30981 0.690674L13.7659 11.1467C14.489 11.8703 14.4893 13.0425 13.7659 13.7659L3.30981 24.2219C2.58642 24.9453 1.4142 24.9451 0.690674 24.2219C-0.0328294 23.4984 -0.0328215 22.3263 0.690674 21.6028L9.83716 12.4563L0.690674 3.30981C-0.032833 2.58631 -0.0328331 1.41418 0.690674 0.690674Z"
                    ...
                    <div class="industyLeft industyFirst">
                        <div class="industyLeftInner">
                            ...
                            <ul class="p-0 d-flex flex-column gap-3 industList">
                                <li>
                                    <span><img src="img/home_page/financeIcon1.svg"></span>
                                    <span>Lending</span>
                                </li>
                                <li>
                                    <span><img src="img/home_page/financeIcon2.svg"></span>
                            ...
                            <div class="mt-3">
                                <button class="exploreBtn d-flex">Explore <span><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-md-6">
                    <div class="industyLeft industyTwo">
                        <div class="industyLeftInner">
                            ...
                            <button class="exploreBtn d-flex mt-3">Explore <span><svg xmlns="http://www.w3.org/2000/svg"
                                        width="15" height="13" viewBox="0 0 15 13" fill="none">
                                        <path
                                            d="M7.29297 0.292969C7.68349 -0.0975555 8.31651 -0.0975555 8.70703 0.292969L13.957 5.54297L14.0254 5.61914C14.3457 6.01191 14.3231 6.59093 13.957 6.95703L8.70703 12.207C8.31652 12.5975 7.68348 12.5975 7.29297 12.207C6.90246 11.8165 6.90248 11.1835 7.29297 10.793L10.8359 7.25H1C0.44774 7.25 4.08113e-05 6.80225 0 6.25C0 5.69772 0.447715 5.25 1 5.25H10.8359L7.29297 1.70703C6.90246 1.31652 6.90248 0.683496 7.29297 0.292969Z"
                                            fill="#294864" />
                    ...
                    <div class="industyLeft industyThree">
                        <div class="industyLeftInner">
                            ...
                            <ul class="p-0 d-flex gap-2 industList flex-wrap">
                                <li>
                                    <span><img src="img/home_page/financeIcon7.svg"></span>
                                    <span>Healthcare</span>
                                </li>
                                <li>
                                    <span><img src="img/home_page/financeIcon8.svg"></span>
                                    <span>Manufacturing</span>
                                </li>
                                <li>
                                    <span><img src="img/home_page/financeIcon9.svg"></span>
                                    <span>Real Estate</span>
                                </li>
                                <li>
                                    <span><img src="img/home_page/financeIcon10.svg"></span>
                                    <span>HiTech</span>
                                </li>
                                <li>
                                    <span><img src="img/home_page/financeIcon11.svg"></span>
                                    <span>Education</span>
                                </li>
                            </ul>
                            <button class="exploreBtn d-flex">Explore <span><svg xmlns="http://www.w3.org/2000/svg"
...
<!------------------------------>
 <section class="sectionSix">
        <div class="container-fluid">
            ...
            <div class="sectionFiveSubHeading text-center mb-4">Dont Just Take Our Words, Hear From Them</div>
            <div class="clientFeeback">
                ...
                <div class="iframe-container"><iframe width="560" height="315"
            ...
            <div class="owl-carousel full-slider home-slider owl-theme p-0">
                <div class="item">
                    <div class="sliderItem">
                        <img src="<?php echo $base_url?>img/lending-logik-imgs/capify.jpg">
                        <div class="sliderContent bg-1 ">
                            ...
                            <div class="sliderContentInner">
                                ...
                                <div class="line2">Enabling Capify to extend Business Loans in Australia & UK with
                                    Salesforce</div>
                                <a class="btn btn-secondry" target="_blank"
                                    href="<?php echo $base_url?>success-stories/capify"><span>Read
                ...
                <div class="item">
                    <div class="sliderItem">
                        <img src="<?php echo $base_url?>img/moneyspot-banner.jpg">
                        <div class="sliderContent bg-3">
                            <div class="sliderContentInner">
                                <div class="line1"> Success <span class="bold">Stories</span></div>
                                <div class="line2"> Driving IFT Solutions’ Auto Lending & Auctioning business with
                                    Salesforce</div>
                                <a class="btn btn-secondry" target="_blank"
                                    href="<?php echo $base_url?>success-stories/IFT"><span>Read
                                        more</span> <img src="img/arrow-right-b.svg" alt="arrow" width="24px"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="call-to-action ss d-flex align-items-center justify-content-between">
                    ...
                    <div class=" flex-column">
                        <h2 class="bold text-start">
                            <div><span class="lightWeight">Let’s Turn Your</span> Challenges Into Success <br> Stories.
                            </div>
        ...
        <div class="row">
            ...
            <div class="grid-container mb-5">
                ...
                <div class="items">
                    ...
                    <div class="ben-result dark-blue bold">
                        <span class="lightWeight">Up to </span> 20% <img src="img/arrow-down.png" alt="">
                    </div>
                </div>
                <div class="items">
                    <p class="ben-ponits dark-blue bold">
                ...
                <div class="items">
                    ...
                    <div class="ben-result dark-blue bold">
                        <span class="lightWeight">Up to </span> 30% <img src="img/arrow-down.png" alt="">
                    </div>
                </div>
            </div>
                        ...
                        <div class="wrap-layout-area wrap-layout-1" data-aos="fade-up">
                            <div class="gridInner">
                                <div class="gridInner-content">
                                    ...
                                    <p>
                                        Specialized Salesforce teams for Finance & Nonprofits-no one-size-fits-all
                                        solutions.
                                    </p>
                    ...
                    <div class="wrap-layout-area wrap-layout-4" data-aos="fade-up">
                        <div class="gridInner flex-row">
                            <div class="gridInner-content">
                                ...
                                <p>
                                    Expert consultants across Sales, Service, Financial Services, and Nonprofit Clouds.
                                </p>
                            ...
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="45" viewBox="0 0 44 45"
                                    ...
                                    <g clip-path="url(#clip0_160_328)">
                                        <mask id="mask0_160_328" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="44" height="45">
    ...
    <div class="container">
        <div class="row">
            <div class="sectionTitle text-center aos-init aos-animate mt-5 mb-2" data-aos="fade-up">
                <span class="lightWeight">Lets Talk </span> <span class="bold text-gradient">About</span>
            </div>

            <div class="cta-wrap position-relative">
                <div class="text">
                    Explore how we can help you create transformational value with Salesforce.
                </div>
                <div class="ai-sf-img">
                    <img src="img/ai-sf-footer.png">
                </div>
                <div class="sf-hero-img position-relative">
                    <img src="img/sf-hero-home-cta.png">
                    <a href="" class="btn btnStarted cta-footer" data-bs-toggle="modal"
                        data-bs-target="#contactUsPopup">Contact Us Now
                        <img src="img/users-group.png" class="ml-2">
                        <img src="img/arrow-white.png" alt="arrow icon" class="ml-2">
                    </a>
                </div>
